L.Geoserver = L.FeatureGroup.extend({
  ...
  legend: function () {
    ...
    legend.onAdd = function (map) {
      ...
      var url = `${that.baseLayerUrl}/wms?REQUEST=GetLegendGraphic&VERSION=1.1.0&FORMAT=image/png&LAYER=${that.options.layers}&style=${that.options.style}&WIDTH=15&HEIGHT=15`;
      div.innerHTML +=
        "<img src='" +
        url +
